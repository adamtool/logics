 ...
 */
class RunCTLForAllFormulaBinary extends FormulaBinary<IRunFormula, RunOperators.Binary, IRunFormula> implements IRunFormula {

    public RunCTLForAllFormulaBinary(IRunFormula phi1, RunOperators.Binary op, IRunFormula phi2) {
        super(phi1, op, phi2);
    }
    ...
    @Override
    public RunCTLForAllFormula createSubstitutedFormula(IFormula subformula, IFormula with) throws NotSubstitutableException {
        ...
        if (phi1 instanceof IRunFormula) {
            if (phi2 instanceof IRunFormula) {
                return new RunCTLForAllFormula((IRunFormula) phi1, getOp(), (IRunFormula) phi2);
            } else {
