...
import static uniolunisaar.adam.logic.transformers.pnwt2pn.PnwtAndFlowLTLtoPN.ACTIVATION_PREFIX_ID;
...
//        List<LTLFormula> allInitPlaces = new ArrayList<>();
        List<FlowFormula> flowFormulas = TransformerTools.getFlowFormulas(f);
